...
u16 tcs3200_RED(void)						//打开红色滤波
{
	...
	delay_ms(10);
	S2=1;S3=0;								//关闭通道 
	Ramount=(u32) amount*255/200;	 			//取R值Ramount=(u32) amount*255/539;	445
...
u16 tcs3200_GREEN(void)					//打开绿色滤波
{
	...
	delay_ms(10);
	S2=1;S3=0;								//关闭通道 
	Gamount=(u32) amount*255/192;				//取G值Gamount=(u32) amount*255/495;	375
...
u16 tcs3200_BLUE(void)						//打开蓝色滤波
{
	...
	delay_ms(10);
	S2=1;S3=0;								//关闭通道 
	Bamount=(u32) amount*255/231;				//取B值	Bamount=(u32) amount*255/622;	 428
