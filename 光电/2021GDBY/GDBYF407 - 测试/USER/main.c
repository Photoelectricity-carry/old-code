...
int main(void)
{
	...
	servo_D(UP);
	servo_E(UP);
	servo_back1(1500);//1700 1500
	servo_back2(2000);//2000 1300 900
	delay_ms(2000);
...
//			servo_back1(1700);
//			servo_back2(2000);
//			if(encoder.all_num_r<-500) break;
//		}
//		clear;
//		time=0;
//		while(1)
...
//		{
//			forward;
//			if(encoder.all_num_r>1050) break;
//		}
...
//			{
//				back;
//				servo_back1(1500);//1800
//				servo_back2(2000);//900
//				if(encoder.all_num_r<-500)if(hd3==1) break;
//			}
//			time=0;while(1){stop;if(time>0.2) break;}
//			while(1)
//			{
...
//		{
//			back;
//			if(encoder.all_num_r<-3000)if(hd3==1) break;//800 2000 3000  -1500 -3000 
//		}
//		clear;
//		time=0;
//		while(1)
...
void turn(int encod)
{
	...
	if(encod>0)
	{
		while(1)
		{
			...
			PID_Calc(&pid_r,encoder.speed_r,3);
			motor_speed( pid_l.out, pid_r.out);
			if(encoder.all_num_r>encod){if(hfm==1) break;}
		}
	}
	if(encod<=0)
	{
		while(1)
		{
			...
			PID_Calc(&pid_r,encoder.speed_r,-3);
			motor_speed( pid_l.out, pid_r.out);
			if(encoder.all_num_l>-encod) {if(hfm==1) break;}
		}
	}
	for(int i=0;i<8;i++)
	{
