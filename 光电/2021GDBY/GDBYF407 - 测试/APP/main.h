...
#define forward 	huidu;\
									if(hfl==0 && hfm==1 && hfr==1){left=6.5;right=5.5;}\
									else if(hfl==0 && hfm==0 && hfr==1){left=7.5;right=4.5;}\
									else if(hfl==1 && hfm==1 && hfr==0){left=5.5;right=6.5;}\
									else if(hfl==1 && hfm==0 && hfr==0){left=4.5;right=7.5;}\
									else {left=6;right=6;}\
