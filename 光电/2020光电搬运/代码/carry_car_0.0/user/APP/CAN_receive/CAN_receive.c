...
void CAN_CMD_cap(int16_t motor10, int16_t motor20)
{
    CanTxMsg TxMessage;
    ...
    TxMessage.RTR = CAN_RTR_Data;
    TxMessage.DLC = 0x08;
    TxMessage.Data[0] = motor20;
    TxMessage.Data[1] = motor10;
    TxMessage.Data[2] = motor20 ;
    TxMessage.Data[3] = motor10;
    TxMessage.Data[4] = motor20 ;
    TxMessage.Data[5] = motor10;
    TxMessage.Data[6] = motor20 ;
    TxMessage.Data[7] = motor10;
...
//返回底盘电机变量地址，通过指针方式获取原始数据
const cap_measure_t *get_cap_Measure_Point(void)
{
    return &get_cap;
}
...
//        DetectHook(PitchGimbalMotorTOE);
		...
		case capid:
    {
        get_cap.invot = (int16_t)((rx_message)->Data[1] << 8 | (rx_message)->Data[0]);        
        get_cap.capvot = (int16_t)((rx_message)->Data[3] << 8 | (rx_message)->Data[2]);       
        get_cap.current = (int16_t)((rx_message)->Data[5] << 8 | (rx_message)->Data[4]);      
        get_cap.power =(int16_t)((rx_message)->Data[7] << 8 | (rx_message)->Data[6]); 
