...
#define left_go      11.0f   //右转弯
#define left_go_cha  8.0f
#define right_go     -11.0f  //左转弯
#define right_go_cha     -8.0f  

//前进巡线
#define left_go_slow      7.5f   //右转弯
#define left_go_cha_slow  5.0f
#define right_go_slow     -7.5f  //左转弯
#define right_go_cha_slow     -5.0f  

//后腿巡线
#define left_goback_slow      -5.0f   //右转弯
#define left_goback_cha_slow  6.0f
#define right_goback_slow     5.0f  //左转弯
#define right_goback_cha_slow     -6.0f  
