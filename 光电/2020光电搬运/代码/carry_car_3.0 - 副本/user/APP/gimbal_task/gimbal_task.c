...
void staight_556(int v,int g);//v  这个的标识   g上一个标识

static void chassis_staight_gray_4(int ff);
void staight_55(int v,int g);//v  这个的标识   g上一个标识
...
void staight_4(int v,int g);//v  这个的标识   g上一个标识
void staight_5(int v,int g);//v  这个的标识   g上一个标识
void staight_pi(int v,int g);//v  这个的标识   g上一个标识
...
void chassis_turn_2(int xiang,int ci,int v);  //左转90
void staight_5566(int v,int g);//v  这个的标识   g上一个标识
...
//////		//白色
    ...
    avv_jiu (2,1);
    avv_jiu_2(3,2);	
		turn_2(4,3,zuo,3);  //左转90
		staight_2(5,4);		  //前进中间
		sevor_on_120(6,5);  //抓
   	back_short(7,6);		//后退
    turn_2(8,7,you,8);//右转45
    staight_3(9,8);		//前进最后
		sevor_on_1(10,9);
  	back_short(11,10);		//后退
		
		//黑色
	  turn_2(12,11,you,8);//转弯到相应
		staight_2(13,12);		//前进中间
		sevor_on_120(14,13);
  	back_short(15,14);		//后退
	  turn_2(16,15,you,8);//转弯到相应
    staight_4(17,16);		//前进中间
		sevor_on_1(18,17);
    back_short(19,18);		//后退

    //绿色
	  turn_2(20,19,you,8);//转弯到相应
    staight_2(21,20);		//前进中间
		sevor_on_120(22,21);   //抓
    back_short(23,22);		//后退
	  turn_2(24,23,you,8);//转弯到相应
	  turn_2(25,24,you,8);//转弯到相应
	  turn_2(26,25,you,8);//转弯到相应
	  turn_2(27,26,you,8);//转弯到相应
    staight_4(28,27);		//前进中间
		sevor_on_1(29,28);
    back_short(30,29);		//后退
		//白色

  	turn_2(31,30,zuo,2);  //左转90
    staight_55(32,31);
	  sevor_on2_120(33,32);
		sevor_on_120(34,33);   //抓
	  sevor_on2_1(35,34);
    back_short(36,35);		//后退
	  turn_2(37,36,you,8);//转弯到相应
	  turn_2(38,37,you,8);//转弯到相应
		turn_2(39,38,you,8);//转弯到相应
    staight_4(40,39);		//前进最后
		sevor_on_1(41,40);

   back_short(42,41);		//后退 
		//红色
	  turn_2(43,42,you,8);//转弯到相应
	  turn_2(44,43,you,8);//转弯到相应
	  turn_2(45,44,you,8);//转弯到相应

    staight_55(46,45);
		sevor_on2_red(47,46);
		sevor_on_120(48,47);   //抓
		sevor_on2_1(49,48);
    back_short(50,49);		//后退
	 //白色
	  turn_2(51,50,you,8);//转弯到相应
	  turn_2(52,51,you,8);//转弯到相应
	  turn_2(53,52,you,8);//转弯到相应
	  turn_2(54,53,you,8);//转弯到相应
    staight_3(55,54);		//前进最后
    sevor_on_1(56,55);  //抬钩子	

// // biao[56]  =  1;
     back_short(57,56);		//后退

//  biao[59] = 1;
		turn_2(58,57,zuo,3);  //左转90
    staight_55(59,58);
	  sevor_on2_w(60,59);
		sevor_on_120(61,60);   //抓
	  sevor_on2_1(62,61);
    back_short(63,62);		//后退
	  turn_2(64,63,you,8);//转弯到相应
	  turn_2(65,64,you,8);//转弯到相应
    staight_3(66,65);		//前进最后
    sevor_on_1(67,66);  //抬钩子	
    back_short(68,67);		//后退
	  turn_2(69,68,you,8);//转弯到相应
	  turn_2(70,69,you,8);//转弯到相应
	  turn_2(71,70,you,8);//转弯到相应
	  turn_2(72,71,you,8);//转弯到相应

//biao[72] = 1;
    staight_55(73,72);
	  sevor_on2_w(74,73);
		sevor_on_120(75,74);   //抓
	  sevor_on2_1(76,75);
    back_short(77,76);		//后退

	  turn_2(78,77,you,8);//转弯到相应
	  turn_2(79,78,you,8);//转弯到相应
	  turn_2(80,79,you,8);//转弯到相应
	  turn_2(81,80,you,8);//转弯到相应
	  turn_2(82,81,you,4);//转弯到相应
    staight_4(83,82);		//前进最后

    sevor_on_1(84,83);  //抬钩子	


    back_short(85,84);		//后退
	  turn_2(86,85,you,8);//转弯到相应
	  turn_2(87,86,you,8);//转弯到相应
	  turn_2(88,87,you,8);//转弯到相应
staight_556(89,88);
	  sevor_on2_b(90,89);
		sevor_on_120(91,90);   //抓
     back_short(92,91);		//后退
		    sevor_on2_1(93,92);

   turn_2(94,93,zuo,2);//转弯到相应
   staight_4(95,94);		//前进最后
   sevor_on_1(96,95);  //抬钩子	

    back_short(97,96);		//后退
	  turn_2(98,97,you,8);//转弯到相应
	  turn_2(99,98,you,8);//转弯到相应
...
if(biao[v]==0&&biao[g]==1)
	{
	chassis_turn_2(xiang,ci,v);  //左转90
	}
}
...
if(key[14]==0&&key[5]==1&&jici[5]==0){
	chassis_move.speed_set[0] = 5.0;  //右转
		  chassis_move.speed_set[1] = 5.0;	
	   	chassis_move.speed_set[2] = 5.0;  
		  chassis_move.speed_set[3] = 5.0;
...
//	chassis_move.speed_set[0] = right_go;  //右转
...
if(jici[7]==0){
	...
	chassis_move.speed_set[0] = left_go;  //右转
		  chassis_move.speed_set[1] = left_go;	
...
void staight_33(int v,int g)//v  这个的标识   g上一个标识
{
  if(biao[v]==0&&biao[g]==1)
	{
...
void staight_6(int v,int g)//v  这个的标识   g上一个标识
{
  if(biao[v]==0&&biao[g]==1)
	{
