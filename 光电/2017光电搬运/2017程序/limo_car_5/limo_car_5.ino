...
void grab_ACE() 
 {
  ...
  while( step_car==15){claw_open_close(claw_3,claw_2,0,1);Stop_car(150);claw_up_down(up_1,-1);Stop_car(150);step_car=16;}//微微张开 然后放下
  ...
  while( step_car==24){claw_open_close(claw_3,claw_2,0,1);Stop_car(150);claw_up_down(up_1,-1);Stop_car(150);step_car=25;}   //微微张开 然后完全放下
  ...
  void go_back_set_one()
{
 ...
 while(step_car==6){claw_up_down(200,1);Stop_car(150);claw_open_close(claw_2,claw_3,0,-1);Stop_car(150);step_car = 8;}
...
{  
 ...
 while(step_car==5){claw_up_down(up_1,-1);Stop_car(150);claw_open_close( claw_3, claw_2,0,1);;Stop_car(150);step_car = 6;}//夹子下降到嘴下面   然后 微微张开_
 while(step_car==6){claw_up_down(up_1,1);Stop_car(150);claw_open_close(claw_2, claw_3,0,-1);Stop_car(150);step_car = 7;}//夹子上升   然后 加紧
...
{ 
 ...
 while(step_car==5){claw_up_down(240,-1);Stop_car(150);claw_open_close(claw_3,claw_1,60,6);Stop_car(150);step_car = 13;}//夹子降到最下面 然后完全张开
...
{    // up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==13){claw_open_close(claw_3,claw_1,60,1);Stop_car(200);blind_back(85,85);step_car=14;} 
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  while(step_car==2){ hunting_go_up(200,200);step_car=3;}
  while(step_car==3){ hunting_up(); get_value();if(a_1 == 1 || a_2 == 1){ step_car = 6;}}//前到中线
  while(step_car==6){hunting_set_go_up(45,45);Stop_car(150);step_car = 7;}
  ...
  while(step_car==12){claw_open_close(claw_1,claw_3,60,-1);Stop_car(50);claw_up_down(up_1,1);Stop_car(80);step_car =13;}//夹子加紧 然后上升 
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}
  while(step_car==14){ go_center(140,10);step_car=0;}
}
/////////////////////////////////////////////////抓取B物块////////////////////////////////////////////////
void drag_A_block()
{   //up_1 = 335 ;up_2 = 445;
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  ...
  while(step_car==12){claw_open_close(claw_1,claw_3,60,-6);Stop_car(50);claw_up_down(up_1,1);Stop_car(150);step_car =13;}//夹子加紧 然后上升
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}
  while(step_car==14){ go_center(145,10);step_car=0;}
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  while(step_car==2){ hunting_go_up(200,200);step_car=3;}
  while(step_car==3){ hunting_up();get_value();if(a_1 == 1 || a_2 == 1 ){step_car =6;}}//前到中线
  while(step_car==6){hunting_set_go_up(60,60);Stop_car(150);step_car = 7;}
  ...
  while(step_car==10){ release_block_right();Stop_car(150);step_car =11;}    
  while(step_car==11){ claw_up_down(up_1+90,-1);hunting_very_slow_go(20,20);Stop_car(150);step_car =12;}//夹子下降  
  while(step_car==12){claw_open_close(claw_1,claw_3,60,-1);Stop_car(50);claw_up_down(up_1,1);Stop_car(150);step_car =13;}//夹子加紧 然后上升  
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}          
  while(step_car==14){ go_center(170,10);step_car=0;}
}
//////////////////////////////////////////////抓取E物块////////////////////////////////////////////////////////
void drag_C_block()
{   
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  ...
  while(step_car==10){ release_block_left();Stop_car(150);step_car =11;}    
  while(step_car==11){claw_up_down(up_1+90,-1); hunting_very_slow_go(20,20);Stop_car(150);step_car =12;}//夹子下降
  while(step_car==12){ claw_open_close(claw_1,claw_3,60,-1);Stop_car(50);claw_up_down(up_1,1);Stop_car(100);step_car =13;} //夹子加紧 然后上升   
...
{  
  ...
  while(step_car==8){claw_open_close(claw_1,claw_3,60,-6);Stop_car(50);claw_up_down(up_1-30,1);Stop_car(150);step_car =9;} //夹子加紧 然后上升   
  while(step_car==9){ turn_direction(4);Stop_car(150);step_car =10;}
