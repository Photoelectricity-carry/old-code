  ...
  void go_back_set_one()
{
 ...
 while(step_car==2){hunting_go(80,80); step_car = 4;}
...
{    // up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==4){ hunting();get_value();if(c_1==1||c_2 == 1 ){hunting_set_go(85,85);Stop_car(150);step_car =6;}} 
...
{  //  up_1 = 335 ;up_2 = 445;
  ...
  while(step_car==2){ hunting_go(200,200);step_car=3;}
...
//  while(step_car==5){hunting_very_slow();get_value();if(a_1 == 1 || a_2 == 1){step_car=6;}}
  while(step_car==6){hunting_set_go(50,50);Stop_car(150);step_car = 7;}
...
{   //up_1 = 335 ;up_2 = 445;
       step_car =1;
  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  while(step_car==2){ hunting_go(200,200);Stop_car(150);step_car=3;}
  while(step_car==3){ hunting();get_value();if(a_1 == 1 || a_2 == 1 ){step_car = 6;}}//前到中线
...
//  while(step_car==5){hunting_very_slow();if(a_1 == 1 || a_2 == 1 ){step_car=6;}}
  while(step_car==6){hunting_set_go(70,70);Stop_car(150);step_car = 7;}
