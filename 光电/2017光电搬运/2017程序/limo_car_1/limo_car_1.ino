...
void setup()
{
  chou_qian_1 = color_L, chou_qian_2 = color_R ,chou_qian_3 = color_W , chou_qian_4 = color_G , chou_qian_5 = color_B;
...
void grab_ACE() 
 {
  ...
  while( step_car==10){ go_center(140,10);step_car = 12;}
  ...
  while( step_car==19){ go_center(140,10);step_car = 21;}
...
{ 
 ...
 while(step_car==15){go_center(162,10);step_car = 0;}
}
 ////////////////////////////////////////取物块后放第一层////////////////////////////////////////
...
{ 
 ...
 while(step_car==1){ Stop_car(150);step_car = 2;}
 while(step_car==2){ hunting_go(90,90);step_car = 4;}
 while(step_car==4){hunting();get_value();if(c_1==1||c_2 == 1){ hunting_very_slow_go(75,75);Stop_car(150);step_car=6;}}            
 ...
 while(step_car==13){ go_center(162,10);step_car = 0;}     
}
/////////////////////////////////////////取物块后放第二层//////////////////////////////////////
...
{    //up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==3){ hunting(); get_value();if(a_1==1||a_2 == 1 ){ hunting_very_slow_go(95,95);step_car = 4; Stop_car(150);}}
 ...
 while(step_car==12){ turn_direction(4);step_car = 16;}
  while(step_car==16){ go_center(105,10);step_car = 0;}
}
/////////////////////////////////////////取物块后放第三层//////////////////////////////////////
...
{  //up_1 = 335 ;up_2 = 445;  
  ...
  while(step_car==1){Stop_car(150);step_car = 2;}
  while(step_car==2){hunting_go(60,60);step_car = 3;}
  while(step_car==3){hunting_set();get_value();if(a_1==1||a_2 == 1 ){hunting_set_go(110,110);Stop_car(150);step_car = 5;}}
  ...
  while(step_car==12){claw_open_close(claw_2,80,-1);Stop_car(300);claw_open_close(80,claw_1,1);Stop_car(150);step_car=15;}
  while(step_car==15){blind_back(90,90);step_car=16;}
  while(step_car==16){turn_direction(4);step_car=17;}
  while(step_car==17){go_center(240,10);step_car = 0;}
}
//////////////////////////////////////////////////放置第二层物块B///////////////////////////////////////////////////
...
{    // up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==4){ hunting();get_value();if(c_1==1||c_2 == 1 ){hunting_set_go(90,90);Stop_car(150);step_car =6;}} 
 while(step_car==6){ step_car = 7;}
 while(step_car==7){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1-30,-1);Stop_car(150);claw_open_close(claw_2,80,-1);Stop_car(200);step_car =8;}
 while(step_car==8){ hunting_set();get_value();if(a_1==1||a_2 == 1){blind_back(2,2);step_car =13;}}
 while(step_car==13){claw_open_close(80,claw_1,1);Stop_car(200);blind_back(85,85);step_car=14;} 
 while(step_car==14){ turn_direction(4);step_car = 15;}
 while(step_car==15){  go_center(280,10);step_car = 0;}
}
//////////////////////////////编码器计数转向///////////////////////////////
...
{  //  up_1 = 335 ;up_2 = 445;
  ...
  while(step_car==2){ hunting_go(60,60);step_car=3;}
  while(step_car==3){ hunting(); get_value();if(a_1 == 1 || a_2 == 1){hunting_go(30,30); step_car = 5;}}//前到中线
//  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}
  ...
  while(step_car==14){ go_center(165,10);step_car=0;}
}
/////////////////////////////////////////////////抓取B物块////////////////////////////////////////////////
void drag_A_block()
{   //up_1 = 335 ;up_2 = 445;
...
//  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}//后到中心
  ...
  while(step_car==6){hunting_set_go(75,75);Stop_car(150);step_car = 7;}
  ...
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}          
  while(step_car==14){ go_center(190,10);step_car=0;}
}
//////////////////////////////////////////////抓取E物块////////////////////////////////////////////////////////
void drag_C_block()
{   
...
{  
  ...
  while(step_car==9){ turn_direction(4);Stop_car(150);step_car =10;}
  while(step_car==10){ go_center(350,10);step_car=0;}
