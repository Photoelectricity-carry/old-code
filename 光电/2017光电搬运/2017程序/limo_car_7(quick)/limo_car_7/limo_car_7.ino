...
{    
 ...
 while(step_car==7){claw_open_close(claw_3,claw_2,0,1);Stop_car(150);claw_up_down(up_1-30,-1);Stop_car(150);step_car =8;}
 while(step_car==8){ hunting_set();get_value();if(a_1==1||a_2 == 1){blind_back(2,2);step_car =13;}}
 while(step_car==13){claw_open_close(claw_2,claw_3,0,-1);Stop_car(300);claw_open_close(claw_3,claw_1,60,1);Stop_car(150);blind_back(90,90);step_car=14;} 
...
void come_back()
{
  ...
  while(step_car==2){hunting();get_value();if(a_1==1||a_2 == 1){hunting_go(150,150);step_car=3;} }
  while(step_car==3){Stop_car(150);step_car=0;}
}
//////////////////////////////////////////////抓取A物块/////////////////////////////////////////////////
void drag_B_block()
{ step_car =2;
...
{   
  ...
  while(step_car==2){ hunting_go_up(200,200);Stop_car(150);step_car=3;}
  while(step_car==3){ hunting_up();get_value();if(a_1 == 1 || a_2 == 1 ){step_car =6;}}//前到中线
  while(step_car==6){hunting_very_slow_go_up(72,72);Stop_car(150);step_car = 7;}
  ...
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}          
  while(step_car==14){ go_center_up(182,10);step_car=0;}
}
//////////////////////////////////////////////抓取E物块////////////////////////////////////////////////////////
void drag_C_block()
{   
