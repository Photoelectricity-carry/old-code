...
int vel_left_x=92,vel_left_s=84,vel_right_x=104,vel_right_s=96;
int step_flag = 0;
int step_car = 0;
int step_turn=0;
...
void get_value()
{
a_1=(analogRead(A8)>=310? 0:1);
a_2=(analogRead(A9)>=310? 0:1);
b_1=(analogRead(A0)>=403? 0:1);
b_2=(analogRead(A1)>=787? 0:1);
b_3=(analogRead(A2)>=661? 0:1);
b_4=(analogRead(A3)>=676? 0:1);
c_1=(analogRead(A4)>=841? 0:1);
c_2=(analogRead(A5)>=763? 0:1);
/////////////////////////////串口监视器打印判断后的数值//////////////////////////////////
Serial.print(a_1);
Serial.print("\t");
Serial.print(a_2);
...
while(i==2)
{
   for( int pos = vel_left_s; pos < vel_left_s+25; pos += 1)  
  {                                  
...
while(i==2)
{
   for( int pos = vel_right_s; pos > vel_right_s-25; pos -= 1)  
  {                                  
...
void set_block_middle_A() 
{
 ...
 while(i==1)
 {
    for( int pos = vel_left_x-55; pos > vel_left_x-70; pos -=1)  
  {                                  
    myservo_left_x.write(pos);
    delay(20);
   } 
...
{step_car=1;
  ...
  while(step_car==2){hunting();get_value();if(a_1 == 1||a_2 == 1) {step_car = 3;}}
  while(step_car==3){ hunting_very_slow_go(20,20);step_car=4; }
  while(step_car==4){hunting_very_slow();get_value();if(c_1 == 1||c_2 == 1) {step_car = 5;}}
  while(step_car==5){hunting_very_slow_go(20,20);step_car = 6;}
  while(step_car==6){hunting_very_slow();get_value();if(c_1 == 1||c_2 == 1) { Stop_car(150);blind_back(b,b);step_car = 0;}}
  }
///////////////////////////////////////////////夹子打开闭合/////////////////////////////////////////////
...
void grab_ACE() 
 {
  ...
  while( step_car==7){ Stop_car(150);claw_open_close(claw_1,claw_3,-2);Stop_car(150);step_car=8;}//夹起物块
  while( step_car==8){ claw_up_down(up_1,2);Stop_car(150);step_car=9;} //抬起夹子
  while( step_car==9){ turn_direction(4);Stop_car(150);step_car=10;}
  while( step_car==10){ go_center(50,10);step_car = 12;}

  while( step_car==12){ turn_direction(2);hunting_go(100,100);step_car=13;}
  ...
  while( step_car==15){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1,-1);Stop_car(150);step_car=16;}//微微张开 然后放下
  while( step_car==16){ claw_open_close(claw_2,claw_3,-1);Stop_car(150);step_car=17;}//加紧爪子
  while( step_car==17){ claw_up_down(up_1,2);Stop_car(150);step_car=18;} //爪子上升
  while( step_car==18){ turn_direction(4);Stop_car(150);step_car=19;}
  while( step_car==19){ go_center(50,10);step_car = 21;}
  
  while( step_car==21){ turn_direction(2);Stop_car(150);hunting_go(100,100);step_car=22;}//转到E方向
  ...
  while( step_car==24){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1,-1);Stop_car(150);step_car=25;}   //微微张开 然后完全放下
  while( step_car==25){claw_open_close(claw_2,claw_3,-1);Stop_car(150);claw_up_down(20,1);step_car=27;}//加紧爪子
  while( step_car==27){ turn_direction(4);Stop_car(150);step_car=28;}
  while( step_car==28){ go_center(50,10);step_car = 0;}
 }
 ///////////////////////////////////////////放置ACE中最底部物块E////////////////////////////////////////////////////
  void go_back_set_one()
{
 ...
 while(step_car==2){hunting_go(90,90); step_car = 4;}
 while(step_car==4){ hunting();get_value();if( c_1== 1||c_2==1 ) { hunting_very_slow_go(80,80);Stop_car(100);step_car=5;}}//4.5
 while(step_car==5){claw_open_close(claw_3,claw_2,1);Stop_car(150);step_car = 6;}//夹子下降 然后 微微张开           
 while(step_car==6){claw_up_down(200,1);Stop_car(150);claw_open_close(claw_2,claw_3,-1);Stop_car(150);step_car = 8;}
 while(step_car==8){claw_up_down(20 ,1); Stop_car(150);blind_back(100,100);Stop_car(150);step_car = 9;}         
 while(step_car==9){turn_direction(4);Stop_car(150);step_car = 10;}
 while(step_car==10){ go_center(137,0);step_car = 0;}
}
////////////////////////////////////////放置ACE中最中部物块C///////////////////////////////////////////
...
{  
 ...
 while(step_car==1){ Stop_car(150);step_car = 2;}
 while(step_car==2){ hunting_go(90,90);step_car = 4;}
 while(step_car==4){ hunting();get_value();if(  c_1== 1||c_2==1 ) { hunting_very_slow_go(80,80);Stop_car(150);step_car=5;}}//4.5
 while(step_car==5){claw_up_down(up_1,-1);Stop_car(150);claw_open_close( claw_3, claw_2,1);;Stop_car(150);step_car = 6;}//夹子下降到嘴下面   然后 微微张开_
 while(step_car==6){claw_up_down(up_1,1);Stop_car(150);claw_open_close(claw_2, claw_3,-1);Stop_car(150);step_car = 7;}//夹子上升   然后 加紧
 ...
 while(step_car==9){go_center(137,0);step_car =0;}     
}
////////////////////////////////////////放置ACE中最上部物块A/////////////////////////////////////////
...
{ 
 ...
 while(step_car==1){ Stop_car(150);step_car = 2;}
 while(step_car==2){ hunting_go(90,90);step_car = 4;}
 while(step_car==4){ hunting();get_value();if(  c_1== 1||c_2==1 ) { hunting_very_slow_go(80,80);Stop_car(150);step_car=5;}}
 while(step_car==5){claw_up_down(240,-1);Stop_car(150);claw_open_close(claw_3,claw_1,6);Stop_car(150);step_car = 13;}//夹子降到最下面 然后完全张开
 while(step_car==13){blind_back(100,100);Stop_car(150);step_car = 14;} 
 while(step_car==14){turn_direction(4);Stop_car(150);step_car = 15;}
 while(step_car==15){go_center(137,0);step_car = 0;}
}
 ////////////////////////////////////////取物块后放第一层////////////////////////////////////////
...
{ 
 ...
 while(step_car==4){hunting();get_value();if(c_1==1||c_2 == 1){ hunting_very_slow_go(80,80);Stop_car(150);step_car=6;}}            
 while(step_car==6){claw_up_down(up_1-30,-1);Stop_car(100);step_car = 10;}//夹子下降
 while(step_car==10){claw_open_close(claw_3,claw_1,1);Stop_car(150);step_car =11;}//夹子完全张开
 while(step_car==11){ blind_back(100,100);Stop_car(50);step_car = 12;}    
 while(step_car==12){ turn_direction(4);Stop_car(50);step_car = 13;}
 while(step_car==13){ go_center(117,5);step_car = 0;}     
}
/////////////////////////////////////////取物块后放第二层//////////////////////////////////////
...
{    //up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==2){hunting_go(100,100);step_car = 3; Stop_car(100);}
 while(step_car==3){ hunting(); get_value();if(a_1==1||a_2 == 1 ){ hunting_very_slow_go(90,90);step_car = 4; Stop_car(150);}}
 while(step_car==4){claw_up_down(up_1,-1);Stop_car(150);step_car = 6;} //夹子下降
 while(step_car==6){claw_open_close(claw_3,claw_1,4);Stop_car(150);step_car =11;}//夹子完全张开
 while(step_car==11){ blind_back(60,60);Stop_car(150);step_car = 12;}    
 while(step_car==12){ turn_direction(4);step_car = 16;}
  while(step_car==16){ go_center(102,5);step_car = 0;}
}
/////////////////////////////////////////取物块后放第三层//////////////////////////////////////
...
{  //up_1 = 335 ;up_2 = 445;  
  step_car = 1;
  while(step_car==1){Stop_car(150);step_car = 2;}
  while(step_car==2){hunting_go(90,90);step_car = 3;}
  while(step_car==3){hunting_set();get_value();if(a_1==1||a_2 == 1 ){hunting_set_go(105,105);Stop_car(150);step_car = 5;}}
  while(step_car==5){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1-30,-1);Stop_car(150);step_car=6;}////1
  while(step_car==6){claw_open_close(claw_2,claw_3,-1);Stop_car(150);claw_up_down(up_1,1);Stop_car(150);step_car=7;}
  while(step_car==7){hunting_very_slow();get_value();hunting_set_go(80,80);Stop_car(150);step_car=8;}
  while(step_car==8){claw_open_close(claw_3,claw_2,1);Stop_car(150);step_car=9;}
  while(step_car==9){claw_up_down(up_1,-1);Stop_car(150);claw_up_down(10,1);Stop_car(150);step_car=10;}
  while(step_car==10){hunting_set();get_value();if(a_1==1||a_2 == 1 ){blind_back(2,2);step_car=12;}}
  while(step_car==12){claw_open_close(claw_2,76,-1);Stop_car(300);claw_open_close(76,claw_1,1);Stop_car(150);step_car=15;}
  while(step_car==15){blind_back(90,90);step_car=16;}
  while(step_car==16){turn_direction(4);step_car=17;}
  while(step_car==17){go_center(167,5);step_car = 0;}
}
//////////////////////////////////////////////////放置第二层物块B///////////////////////////////////////////////////
...
{    // up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==4){ hunting();get_value();if(c_1==1||c_2 == 1 ){hunting_set_go(80,80);Stop_car(150);step_car =6;}} 
 while(step_car==6){ step_car = 7;}
 while(step_car==7){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1-30,-1);Stop_car(150);claw_open_close(claw_2,76,-1);Stop_car(200);step_car =8;}
 while(step_car==8){ hunting_set();get_value();if(a_1==1||a_2 == 1){blind_back(2,2);step_car =13;}}
 while(step_car==13){claw_open_close(76,claw_1,1);Stop_car(200);blind_back(85,85);step_car=14;} 
 while(step_car==14){ turn_direction(4);step_car = 15;}
 while(step_car==15){  go_center(145,5);step_car = 0;}
}
//////////////////////////////编码器计数转向///////////////////////////////
...
{  //  up_1 = 335 ;up_2 = 445;
  ...
  while(step_car==2){ hunting_go(90,90);step_car=3;}
  while(step_car==3){ hunting(); get_value();if(a_1 == 1 || a_2 == 1){step_car = 4;}}//前到中线
  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}
  while(step_car==5){hunting_very_slow();get_value();if(a_1 == 1 || a_2 == 1){step_car=6;}}
  while(step_car==6){hunting_set_go(57,57);Stop_car(150);step_car = 7;}
  while(step_car==7){ drag_A();Stop_car(100);step_car = 8;}
  while(step_car==8){blind_back(100,100);Stop_car(150);step_car =9;}
  while(step_car==9){ set_block_middle_A();Stop_car(150);step_car =10;}    
  while(step_car==10){release_block_left() ;Stop_car(150);step_car =11;}    
  while(step_car==11){ claw_up_down(up_1+95,-1);hunting_very_slow_go(35,35);Stop_car(150);step_car =12;}//夹子下降  
  while(step_car==12){claw_open_close(claw_1,claw_3,-1);Stop_car(80);claw_up_down(up_1,1);Stop_car(80);step_car =13;}//夹子加紧 然后上升 
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}
  while(step_car==14){ go_center(170,5);step_car=0;}
}
/////////////////////////////////////////////////抓取B物块////////////////////////////////////////////////
void drag_A_block()
{   //up_1 = 335 ;up_2 = 445;
  ...
  while(step_car==2){ hunting_go(90,90);step_car=3;}
  while(step_car==3){ hunting();get_value();if(a_1 == 1 || a_2 == 1 ){ step_car = 4;}}//前到中线
  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}//后到中心
  while(step_car==5){hunting_very_slow();get_value();if(a_1 == 1 || a_2 == 1){step_car=6;}}
  while(step_car==6){hunting_set_go(57,57);Stop_car(150);step_car = 7;}
  ...
  while(step_car==11){claw_up_down(up_1+95,-1);hunting_very_slow_go(30,30);step_car =12;}//夹子下降
  while(step_car==12){claw_open_close(up_1,claw_3,-6);Stop_car(100);claw_up_down(up_1,1);Stop_car(150);step_car =13;}//夹子加紧 然后上升
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}
  while(step_car==14){ go_center(180,5);step_car=0;}
...
{   
  ...
  while(step_car==3){ hunting();get_value();if(a_1 == 1 || a_2 == 1 ){ step_car = 4;}}//前到中线
  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}//后到中心
  while(step_car==5){hunting_very_slow();if(a_1 == 1 || a_2 == 1 ){step_car=6;}}
  while(step_car==6){hunting_set_go(77,77);Stop_car(150);step_car = 7;}
  while(step_car==7){ drag_C();step_car = 8;}
  while(step_car==8){ blind_back(120,120);Stop_car(150);step_car =9;}
  while(step_car==9){ set_block_middle_C();Stop_car(150);step_car =10;}    
  while(step_car==10){ release_block_right();Stop_car(150);step_car =11;}    
  while(step_car==11){ claw_up_down(up_1+95,-1);hunting_very_slow_go(30,30);Stop_car(150);step_car =12;}//夹子下降  
  while(step_car==12){claw_open_close(claw_1,claw_3,-1);Stop_car(150);claw_up_down(up_1,1);Stop_car(150);step_car =13;}//夹子加紧 然后上升  
  while(step_car==13){ turn_direction(4);Stop_car(150);step_car =14;}          
  while(step_car==14){ go_center(187,5);step_car=0;}
}
//////////////////////////////////////////////抓取E物块////////////////////////////////////////////////////////
void drag_C_block()
{   
  ...
  while(step_car==10){ release_block_left();Stop_car(150);step_car =11;}    
  while(step_car==11){claw_up_down(up_1+95,-1); hunting_very_slow_go(30,30);Stop_car(150);step_car =12;}//夹子下降
  while(step_car==12){ claw_open_close(claw_1,claw_3,-1);Stop_car(150);claw_up_down(up_1,1);Stop_car(100);step_car =13;} //夹子加紧 然后上升   
  while(step_car==13){ turn_direction(4);step_car =14;}
  while(step_car==14){ go_center(187,5);step_car=0;}
  //while(step_car==15){ hunting();get_value();if(c_1==1||c_2==1) { hunting_go(45,45);Stop_car(150);step_car = 0;}}//夹子处于90
}
////////////////////////////////////////////////抓取D物块//////////////////////////////////////////////////
void drag_D_block() 
{  
  ...
  while(step_car==4){hunting();get_value();if(c_1==1||c_2==1){step_car = 5;}}//后到中心
  while(step_car==5){hunting_very_slow();get_value();if(a_1 == 1 || a_2 == 1){step_car=6;}}
  while(step_car==6){hunting_set_go(140,140);Stop_car(150);step_car = 8;}   
  while(step_car==8){claw_open_close(claw_1,claw_3,-6);Stop_car(150);claw_up_down(up_1-30,1);Stop_car(150);step_car =9;} //夹子加紧 然后上升   
  while(step_car==9){ turn_direction(4);Stop_car(150);step_car =10;}
  while(step_car==10){ go_center(345,5);step_car=0;}
//  while(step_car==11){ hunting(); get_value();if(c_1==1||c_2==1) { hunting_very_slow_go(10,10);Stop_car(150);step_car = 0;}}  //夹子处于90 
}
