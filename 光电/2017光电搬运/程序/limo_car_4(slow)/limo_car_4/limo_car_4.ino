...
void setup()
{
  ...
  myservo_front.write(0);//大,大178,82,112
}
//////////////////////////////////////////编码器中断函数////////////////////////////////////
 void Code_right()
{
...
void get_value()
{
a_1=(analogRead(A0)>=500? 0:1);
a_2=(analogRead(A1)>=500? 0:1);
b_1=(analogRead(A2)>=600? 0:1);
b_2=(analogRead(A3)>=600? 0:1);
b_3=(analogRead(A4)>=600? 0:1);
b_4=(analogRead(A5)>=600? 0:1);
c_1=(analogRead(A8)>=400? 0:1);
c_2=(analogRead(A9)>=350? 0:1);
///////////////////////////////串口监视器打印判断后的数值//////////////////////////////////
//Serial.print(a_1);
//Serial.print("\t");
//Serial.print(a_2);
...
{    // up_1 = 335 ;up_2 = 445;
 ...
 while(step_car==1){Stop_car(150);step_car = 2;}
 while(step_car==2){ hunting_go(60,60);step_car = 3;}
 while(step_car==3){ hunting();get_value();if(a_1==1||a_2 ==1){ hunting_go(150,150);hunting_set_go(30,30);Stop_car(150);step_car =7;}}//从过中线
 while(step_car==7){claw_open_close(claw_3,claw_2,1);Stop_car(150);claw_up_down(up_1-30,-1);Stop_car(150);step_car =8;}
 while(step_car==8){ hunting_set();get_value();if(a_1==1||a_2 == 1){blind_back(2,2);step_car =13;}}
 while(step_car==13){claw_open_close(claw_2,claw_3,-1);Stop_car(300);claw_open_close(claw_3,claw_1,1);Stop_car(150);blind_back(90,90);step_car=14;} 
...
{
  step_car =1;
  while(step_car==1){ hunting_go(200,200);step_car=2;}
  while(step_car==2){hunting();get_value();if(a_1==1||a_2 == 1){hunting_go(150,150);step_car=4;} }
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  while(step_car==2){ hunting_go_up(200,200);elevator_up(135);step_car=3;}
  ...
  while(step_car==11){ claw_up_down(up_1+90,-1);hunting_very_slow_go(35,35);Stop_car(150);step_car =12;}//夹子下降  
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  ...
  while(step_car==11){claw_up_down(up_1+90,-1);hunting_very_slow_go(30,30);step_car =12;}//夹子下降
...
//  while(step_car==1){elevator_up(200);Stop_car(150);step_car=2;}  
  ...
  while(step_car==10){ release_block_right();Stop_car(150);step_car =11;}    
  while(step_car==11){ claw_up_down(up_1+90,-1);hunting_very_slow_go(30,30);Stop_car(150);step_car =12;}//夹子下降  
